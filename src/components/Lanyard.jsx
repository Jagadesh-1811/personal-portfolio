...
const DEFAULT_LANYARD_TEXTURE = '/jaggu.jpeg';
...
export default function Lanyard({
  ...
  return (
    <div
      className={`relative z-0 flex w-full h-full min-h-170 items-center justify-end overflow-visible ${className}`.trim()}>
      <Canvas
...
function Band({
  ...
  const rawTexture = useTexture(lanyardImage || DEFAULT_LANYARD_TEXTURE);
  const lanyardTexture = useMemo(() => {
    const configuredTexture = rawTexture.clone();
